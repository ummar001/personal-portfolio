  ...
  return (
    <section>
      <div className="grid grid-cols-7 lg:grid-cols-12">
        ...
        <div
  className="col-span-7 place-self-center text-left sm:text-left"
  style={{ left: "10%", paddingRight: "30%" }}
>
  <div className="absolute mt-20 sm:mt-20">
    <TypeAnimationComponent className="absolute top-0 left-1/2 transform -translate-x-1/2" />
  </div>
</div>

        <div className="relative col-span-7 place-self-center text-center sm:text-left">
